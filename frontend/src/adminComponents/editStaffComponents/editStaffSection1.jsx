  ...
  const handleResetPassword = async (staffId) => {
    ...
    try {
      ...
      const res = await fetch(
        `https://dromdrop.onrender.com/auth/resetStaffPassword/${staffId}?adminEmail=${adminEmail}`,
        {
          method: "PATCH",
          headers: {
  ...
  const handleDelete = async (id) => {
    ...
    if (confirmAction) {
      try {
        ...
        const res = await fetch(
          `https://dromdrop.onrender.com/auth/deleteStaff/${id}?adminEmail=${adminEmail}`,
          {
            method: "DELETE",
